...
const PaymentScreen = () => {
    ...
    const purchase = async () => {
        ...
        try {
            const response = await axios.post(`http://${process.env.API_URL2}:8080/subscription/purchase`,
                data, {
                    headers: {
            ...
            <ScrollView style={styles.container} contentContainerStyle={{paddingBottom: 50}}>
                ...
                <View style={styles.itemsContainer}>
                    ...
                    <View style={styles.saleLayout}>
                        ...
                        <View style={styles.alignCenter}>
                            ...
                            <View style={styles.row}>
                                ...
                                <TextInput
                                    style={[styles.usePointInput, {paddingBottom: 3, marginLeft: 8}]}
                                    placeholder={"추천인 ID"}
                            ...
                            <View style={styles.row}>
                                ...
                                <TouchableOpacity onPress={() => setModalVisible(true)}
                                                  style={[styles.usePointInput, {marginLeft: 10}]}>
                    ...
                    <View style={styles.total}>
                        <Text style={styles.orderInfo}>총 수량 : 1개</Text>
                        <Text style={styles.orderInfo}>총 금액 : {packagePrice}원</Text>
                        <Text style={styles.orderInfo}>할인금액 : {usedPoints}원</Text>
                    </View>
                    <View style={{flex:1,alignItems:"center"}}>
                        <Text style={{fontSize: 20, fontWeight: "bold"}}>최종 결제 금액</Text>
                        <Text
                            style={[styles.totalFont, {fontSize: 25}]}>{packagePrice - usedPoints}원</Text>
                    </View>
                </View>
